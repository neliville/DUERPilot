...
**Changements v1.1 :**
- Plan FREE : 10 → **5 évaluations/mois** (pousser conversion vers Starter)
- Plan STARTER : **99€/mois** (test A/B possible avec 69€/mois - à décider après 3 mois)
- Plan PRO : **249€/mois** (inchangé - prix cohérent pour PME structurées)
- Plan EXPERT : 499€ → **599€/mois**, IA limitée à **300 appels/mois** (marge positive)
...
Passez au plan Starter pour accéder aux référentiels OiRA et à l'assistance IA."
```
...
Passez au plan Starter pour accéder à l'assistance IA (10-15 appels/mois)."
```
...
- **TPE** : 1 à 20 salariés
- **Profil** : Dirigeant / RH polyvalent, peu ou pas expert QSE
- **Objectif** : DUERP simplifié avec assistance

### 3.2 Modes d'évaluation autorisés

- ✅ **ÉVALUATION GÉNÉRIQUE** (sans IA)
- ✅ **MÉTHODE GUIDÉE ASSISTÉE PAR IA** (OiRA)
- ❌ Méthode classique INRS : **INTERDITE**
...
**Entreprise et structure :**
- 1 entreprise maximum
- Accès aux secteurs OiRA (référentiels disponibles)
- Accès aux risques génériques INRS
- Pas d'unités de travail (DUERP global ou structuré par questions OiRA)
...
- Questions guidées OiRA par secteur
- Réponses Oui/Non/Partiellement/Non applicable
- Sélection des mesures de prévention appliquées
- Validation humaine obligatoire des risques
- Structuration par questions OiRA (pas par unités de travail)

**Export et historique :**
- Export PDF complet
- Mise à jour annuelle facilitée
- Pas d'historique de versions complet
...
**IA autorisée UNIQUEMENT après validation humaine :**
- ✅ Suggestion d'actions de prévention (après validation des risques OiRA)
- ✅ Cotation indicative simplifiée (F×P×G×M suggérée, non obligatoire)
- ✅ Reformulation pédagogique (aide à la compréhension)
...
**Quota IA :**
- **10 à 15 appels IA / mois**
- Blocage strict au dépassement
...
- **Sites** : 1
- **Unités de travail** : 0 (non disponible)
- **Risques évalués** : 50/mois
- **Appels IA** : 10-15/mois (blocage au dépassement)
- **Exports PDF** : 4/an (trimestriels)
- **Utilisateurs** : 3
- **Référentiels OiRA** : Tous disponibles

### 3.6 Objectif produit

- Choix libre entre simplicité (générique) et accompagnement (IA)
- Gain de temps pour TPE
- Upsell vers Pro pour unités de travail

### 3.7 Blocages et messages

**Si tentative d'utilisation méthode classique :**
```
"La méthode classique INRS (par unités de travail) n'est pas disponible dans le plan Starter.
Passez au plan Pro pour accéder aux unités de travail et à la cotation F×P×G×M."
```

**Si dépassement quota IA :**
```
"Vous avez atteint votre quota mensuel d'appels IA (15/15).
Passez au plan Pro pour accéder à 40-60 appels IA/mois, ou attendez le mois prochain."
[Upsell vers Pro]
```

**Si tentative d'IA avant validation :**
```
"L'assistance IA est disponible uniquement après validation des risques.
Veuillez d'abord valider les risques identifiés depuis les questions OiRA."
```
