...
**Plans actuels :**
- FREE (0€) - Découverte
- ESSENTIEL (29€) - TPE avec méthode INRS
- PRO (79€) - PME avec IA + Import + API
- EXPERT (149€) - Tout illimité + IA avancée
...
1. **Test Free :**
   - Vérifier que méthode INRS est bloquée
   - Vérifier que l'IA est bloquée
   - Vérifier limite 3 unités de travail

2. **Test ESSENTIEL :**
   - Vérifier que méthode INRS fonctionne
   - Vérifier que l'IA est bloquée (0 appels)
   - Vérifier limite 10 unités de travail
   - Vérifier que l'import est bloqué

3. **Test PRO :**
   - Vérifier que toutes les méthodes fonctionnent
   - Vérifier les limites (50 unités, 100 risques/mois)
   - Vérifier que quota IA fonctionne (50 suggestions risques/mois)
   - Vérifier que l'import fonctionne (5/mois)

4. **Test EXPERT :**
   - Vérifier que tout est illimité
   - Vérifier que quota IA fonctionne (200 suggestions risques + 50 actions/mois)
